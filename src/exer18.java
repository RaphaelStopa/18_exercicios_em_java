...
//        aparece, ou seja, deve-se escrever cada um dos valores distintos que aparecem na entrada por ordem crescente de valor.
//
//        Entrada
//        A primeira linha de entrada contem um único inteiro N, que indica a quantidade de valores que serão
//        lidos para X (1 ≤ N ≤ 2000) logo em seguida. Com certeza cada número não aparecerá mais do que 20 vezes na entrada de dados.
//
//        Saída
...
public class Contagem_Repetida_Numeros {
